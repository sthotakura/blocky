...
public class BlockyRuleRepoTests
{
    ...
    public void Setup()
    {
        ...
        _sut = new BlockyRuleRepo(_dbContextFactory);
    }
    ...
    [Test]
    public async Task AddAsync_NullRule_ThrowsArgumentNullException()
    {
        // Act & Assert
    ...
    [Test]
    public async Task UpdateAsync_NonExistentRule_ThrowsKeyNotFoundException()
    {
        // Arrange
    ...
    [Test]
    public async Task UpdateAsync_NullRule_ThrowsArgumentNullException()
    {
        // Act & Assert
    ...
    [Test]
    public async Task DeleteAsync_NonExistentRule_ThrowsKeyNotFoundException()
    {
        // Arrange
        var nonExistentId = Guid.NewGuid();
